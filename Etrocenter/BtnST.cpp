...
*/
	...
	*/
    ...
    //Javan Pending pDC->SelectObject(pOldFont);
...
{
	m_crColors[BTNST_COLOR_BK_IN]		=  GLOBALBKCOLOR;//::GetSysColor(COLOR_BTNFACE);
	m_crColors[BTNST_COLOR_FG_IN]		= ::GetSysColor(COLOR_BTNTEXT);
	m_crColors[BTNST_COLOR_BK_OUT]		= GLOBALBKCOLOR;//::GetSysColor(COLOR_BTNFACE);
	m_crColors[BTNST_COLOR_FG_OUT]		= ::GetSysColor(COLOR_BTNTEXT);
	m_crColors[BTNST_COLOR_BK_FOCUS]	= GLOBALBKCOLOR;//::GetSysColor(COLOR_BTNFACE);
...
void CButtonST::SetTooltipText(int nText, BOOL bActivate)
{
	...
	sText.LoadString(CProductDefine::g_hResStr, nText);
