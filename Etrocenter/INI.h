...
public:
	...
	//char* getKeyValue(CString strKey,CString strSection);

	// default constructor
	CIniReader()
	{
		setINIFullFileName(_T("\ec.ini")); //default
	...
	CString csGetInIPath(){ return m_strFileName;};
	void setINIFullFileName(CString strINIFile);
